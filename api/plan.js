const PLAN_SCHEMA = {
  ...
  properties: {
    title: { type: 'string' },
    dueDate: { type: 'string', description: 'ISO 8601 date-time, or empty string when unknown' },
    reminderDate: { type: 'string', description: 'ISO 8601 date-time, or empty string when unknown' },
